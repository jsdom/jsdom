...
const resourceLoader = require("./jsdom/browser/old-resource-loader");
...
exports.jsdom = function (html, options) {
  ...
  options.resourceLoader = options.resourceLoader === undefined ?
    new ResourceLoader() :
...
function processHTML(config) {
  ...
  if (config.scripts.length > 0 || config.src.length > 0) {
    ...
    window.addEventListener("load", scriptComplete, { once: true });
  }
}
