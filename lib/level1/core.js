...
core.NodeList.prototype = {
  ...
  toString: function() {
    return '[ jsdom NodeList ]: ' + this.length;
  }
};
// TODO: NO!
...
core.Document.prototype = {
  ...
  get nodeName() { return this._nodeName.toUpperCase(); },
  get attributes() { return null; },
  ...
  appendChild : function(/* Node */ newChild){
    ...
    if (this.readonly === true) {
	  ...
	  if (!this._documentElement && newChild.nodeType === this.ELEMENT_NODE) {
        newChild._ownerDocument = this._documentElement;
...
core.EntityReference.prototype = {
  ...
  // Proxy to the entity
  get nodeName() { return this._entity.nodeName.toUpperCase(); },
