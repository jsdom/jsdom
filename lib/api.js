...
const { createWindow, setBeforeParse } = require("./jsdom/browser/Window.js");
...
class JSDOM {
  constructor(input, options = {}) {
    ...
    setBeforeParse(options.beforeParse);

    this[window] = createWindow(options.windowOptions, { isMain: true });
