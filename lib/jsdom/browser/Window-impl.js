...
exports.init = (windowImpl, { wrapper }) => {
  wrapper.addEventListener = wrapper.addEventListener.bind(wrapper);
  wrapper.removeEventListener = wrapper.removeEventListener.bind(wrapper);
  wrapper.dispatchEvent = wrapper.dispatchEvent.bind(wrapper);

  wrapper.setTimeout = wrapper.setTimeout.bind(wrapper);
  wrapper.setInterval = wrapper.setInterval.bind(wrapper);
  wrapper.clearTimeout = wrapper.clearTimeout.bind(wrapper);
  wrapper.clearInterval = wrapper.clearInterval.bind(wrapper);
