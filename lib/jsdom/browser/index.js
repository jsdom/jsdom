...
exports.windowAugmentation = function(dom, options) {
  ...
  if (!options.document) {
    ...
    options.document = browser.createDocument(options);
  }
...
DOMWindow.prototype = {
  ...
  addEventListener: function() {
    this.dom.Node.prototype.addEventListener.apply(this, arguments);
  },
  dispatchEvent: function() {
    this.dom.Node.prototype.dispatchEvent.apply(this, arguments);
  },
  navigator: {
...
exports.createWindow = function(dom, options) {
  return new DOMWindow(dom, options);
};
...
var browserAugmentation = exports.browserAugmentation = function(dom, options) {
  ...
  if (!dom.createDocument) {
    dom.createDocument = function(options) {
      var doc = new dom.Document(options);
