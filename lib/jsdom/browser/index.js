...
var browserAugmentation = exports.browserAugmentation = function(dom, options) {
  ...
  dom.HTMLDocument.prototype.querySelector = function(selector) {
    return Sizzle(selector, this)[0];
  };

  dom.HTMLDocument.prototype.querySelectorAll = function(selector) {
    var self = this;
  ...
  dom.HTMLElement.prototype.querySelector = function(selector) {
    return Sizzle(selector, this)[0];
  };

  dom.HTMLElement.prototype.querySelectorAll = function(selector) {
    var self = this;
