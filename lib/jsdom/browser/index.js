  ...
  DOMWindow.prototype = {
    ...
    getComputedStyle: function(node) {
      ...
      cs.__proto__ = {
		...
		for(var exp=/-([a-z])/; 
		exp.test(name); 
		name=name.replace(exp,RegExp.$1.toUpperCase()));
		//modif
		
		if (typeof(node.style[name])!='undefined')
		{
...
dom.Element.prototype.__defineGetter__('offsetWidth', function() {return 320;});

dom.Element.prototype.__defineGetter__('offsetHeight', function() {return 480;});
