...
function parseFragment(markup, contextElement, scriptingMode = "Inert") {
  ...
  return parseAlgorithm(markup, contextElement, scriptingMode);
}
...
module.exports = {
  parseFragment,
  parseIntoDocument,
  HTMLDocumentParser: htmlParser.HTMLDocumentParser,
  XMLDocumentParser: xmlParser.XMLDocumentParser
};
