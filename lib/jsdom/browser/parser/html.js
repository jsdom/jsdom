...
class JSDOMParse5Adapter {
  constructor(documentImpl) {
    console.log('JSDOMParse5Adapter');
...
function parseFragment(markup, contextElement) {
  console.log('parseFragment', 'start');
  ...
  treeAdapter.clear();
  console.log('parseFragment', 'end');
  return result;
}

function parseIntoDocument(markup, ownerDocument) {
  console.log('parseIntoDocument', 'start');
  const treeAdapter = new JSDOMParse5Adapter(ownerDocument);
  const config = Object.assign({}, ownerDocument._parseOptions, {
    treeAdapter,
  });
  ...
  treeAdapter.clear();
  console.log('parseIntoDocument', 'end');
  return result;
}
