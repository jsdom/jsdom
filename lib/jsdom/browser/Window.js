...
var stringContainsUTF8Chars = require("../utils").stringContainsUTF8Chars;
...
function Window(options) {
  ...
  this.atob = function (base64String) {
    return new Buffer(base64String, "base64").toString("binary");
  };

  this.btoa = function (plainString) {
    if (stringContainsUTF8Chars(plainString)) {
      // TODO: InvalidCharacterError? DOMError?
      throw new Error("String contains an invalid character");
    }
    return new Buffer(plainString, "binary").toString("base64");
  };
