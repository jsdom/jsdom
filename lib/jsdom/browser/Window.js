...
function Window(options) {
  ...
  this._core.Document.interface.prototype.createExpression =
    this._core.XPathEvaluator.prototype.createExpression;

  this._core.Document.interface.prototype.createNSResolver =
    this._core.XPathEvaluator.prototype.createNSResolver;

  this._core.Document.interface.prototype.evaluate =
    this._core.XPathEvaluator.prototype.evaluate;
