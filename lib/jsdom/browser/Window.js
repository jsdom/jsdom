...
function Window(options) {
  ...
  this.FileReader = this.createFileReader(this);
  this.XMLHttpRequest = this.createXMLHttpRequest(this);
  delete this.createFileReader;
  delete this.createXMLHttpRequest;
