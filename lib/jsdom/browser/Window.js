...
let beforeParse;
const beforeParseDefaultOptions = { isMain: false };

exports.setBeforeParse = function (cb) {
  beforeParse = cb;
};

exports.createWindow = function (options, beforeParseOptions) {
  const window = new Window(options);
  beforeParse(window, Object.assign({}, beforeParseDefaultOptions, beforeParseOptions));
  return window;
};
