...
exports.createWindow = options => {
  ...
  // Also set _sdGlobalObject and _globalProxy.
  //
  // TODO: don't expose _sdGlobalObject and _globalProxy as public properties. While you're there, audit usage sites to
  // see how necessary they really are.
  if (makeVMContext) {
    window = vm.createContext(vm.constants.DONT_CONTEXTIFY);

    window._sdGlobalObject = window;
    ...
    window._sdGlobalObject = window._globalProxy = window;
