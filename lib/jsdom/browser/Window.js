...
const { DEFAULT_USER_AGENT } = require("./resources/resource-loader");
...
function installOwnProperties(window, options) {
  ...
  const userAgent = window._resourceLoader?._userAgent ?? DEFAULT_USER_AGENT;
  const navigator = Navigator.create(window, [], { userAgent });
