...
const { propertiesWithResolvedValueImplemented } = require("../living/helpers/resolved-properties");
...
function Window(options) {
  ...
  this.getComputedStyle = function (elt, pseudoElt = undefined) {
    ...
    forEach.call(declarations, property => {
      const resolvedProperty = getResolvedValue(elt, property);
      declaration.setProperty(
        property,
        resolvedProperty.value,
        resolvedProperty.priority);
    });
