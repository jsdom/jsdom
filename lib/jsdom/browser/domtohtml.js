...
var HTMLEncode = require('./htmlencoding').HTMLEncode,
    removeChars = require('./htmlencoding').removeChars;
...
exports.stringifyElement = function stringifyElement(element) {
  ...
  if (element.twigTags && element.twigTags.length) {
    ret.start += " " + element.twigTags.join(" ");
  }
...
exports.forceRaw = function() {
  forceRaw = true;
}

exports.ignoreChars = function(chars) {
  removeChars(chars);
}

exports.domToHtml = function(dom, noformat, raw) {
  raw = forceRaw ? true : raw;
