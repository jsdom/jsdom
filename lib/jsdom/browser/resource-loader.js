...
//NOTE: request wraps tough-cookie cookie jar (https://github.com/request/request/blob/master/lib/cookies.js).
//Therefore, to pass our cookie jar to the request, we need to create request's wrapper and monkey patch it with our jar.
