...
exports.load = function (element, urlString, options, callback) {
  ...
  exports.loadBase(document, urlString, options, enqueued);
};

exports.loadBase = function (document, urlString, options, enqueued) {
  const documentImpl = document.implementation;
  ...
  function wrappedEnqueued() {
    ...
    if (document && document.defaultView.document) {
