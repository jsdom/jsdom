...
function sendStreamResponse(handler, stream, { status, statusText = "", headers = {}, context = {} }) {
  ...
  function onError(error) {
    // Report failure without waiting for destruction: a synthetic body's `cancel()` can remain pending.
    // Consume destruction's eventual error without notifying the handler again.
