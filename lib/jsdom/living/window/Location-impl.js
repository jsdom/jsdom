...
exports.implementation = class LocationImpl {
  ...
  _locationObjectNavigate(url, { replacement = false } = {}) {
    ...
    console.warn("\x1b[33m Navigation is not implemented on jsdom as integration tests doesn't require it. But you can test window.location changes.");
