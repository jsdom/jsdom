...
const tokenRegexp = require("../utils").tokenRegexp;
const fieldValueRegexp = require("../utils").fieldValueRegexp;
const headerListSeparatorRegexp = require("../utils").headerListSeparatorRegexp;
...
module.exports = function createXMLHttpRequest(window) {
  ...
  class XMLHttpRequest extends XMLHttpRequestEventTarget {
    ...
    get response() {
      ...
      switch (this.responseType) {
        ...
        case "json":
          ...
          const jsonStr = decodeString(properties.responseBuffer, contentType, flag.encoding, false).data;
          try {
    ...
    get responseText() {
      ...
      const contentType = getContentType(this);
      const res = decodeString(responseBuffer, contentType, flag.encoding, false).data;
    ...
    get responseXML() {
      ...
      const resText = decodeString(responseBuffer, contentType, flag.encoding, true);
      if (!resText.data) {
        return null;
      }
      ...
      const res = Document.create([], { core: window._core, options: {
        ...
        encoding: flag.encoding,
        characterSet: resText.charset
      } });
    ...
    getResponseHeader(header) {
      ...
      if (lcHeader === "set-cookie" || lcHeader === "set-cookie2") {
        return null;
      }
      ...
      try {
        if (!flag.body &&
          ...
          if (body instanceof FormData) {
            ...
            flag.requestHeaders["Content-Type"] = body.contentType + ";charset=" + flag.encoding;
    ...
    setRequestHeader(header, value) {
      ...
      if(lcHeader === "content-type") {
        const lcCharset = flag.encoding.toLowerCase();
        ...
        if (contentType) {
          contentType.parameterList
            ...
            .forEach(v => v.value = flag.encoding);
