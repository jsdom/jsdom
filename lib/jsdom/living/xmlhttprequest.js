...
module.exports = function createXMLHttpRequest(window) {
  // TODO: - clean this up
  //       - add help method to extract the right prototype from the globalObject
  class XMLHttpRequest extends window.XMLHttpRequestEventTarget {
    ...
    get responseXML() {
      ...
      const res = Document.create(this._globalObject, [], { options: {
        url: flag.uri,
      ...
      try {
        parseIntoDocument(resText, resImpl, this._globalObject);
      } catch (e) {
