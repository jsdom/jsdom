...
module.exports = function createXMLHttpRequest(window) {
  ...
  class XMLHttpRequest extends XMLHttpRequestEventTarget {
    constructor() {
      ...
      this[xhrSymbols.flag] = {
        ...
        defaultEncoding: this._ownerDocument._defaultEncoding,
    ...
    get responseXML() {
      ...
      const res = Document.create([], { core: window._core, options: {
        ...
        defaultEncoding: flag.defaultEncoding,
  ...
  function dispatchError(xhr, progress) {
    ...
    if (xhr._ownerDocument) {
      xhr._ownerDocument._defaultView._virtualConsole.emit("jsdomError", new Error(properties.error));
    }
  }
