  ...
  class XMLHttpRequest extends XMLHttpRequestEventTarget {
    constructor() {
      ...
      this[xhrSymbols.flag] = {
        ...
        formData: false,
        preflight: false,
        requestManager: this._ownerDocument[internalConstants.requestManager],
        pool: this._ownerDocument[internalConstants.pool],
        agentOptions: this._ownerDocument[internalConstants.agentOptions],
        strictSSL: this._ownerDocument[internalConstants.strictSSL],
