...
class SelectionImpl {
  ...
  collapse(node, offset) {
    ...
    if (node.getRootNode() !== implForWrapper(this._globalObject._document)) {
      return;
    }
  ...
  containsNode(node, allowPartialContainment) {
    if (this._isEmpty() || node.getRootNode() !== implForWrapper(this._globalObject._document)) {
      return false;
    }
