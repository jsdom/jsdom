...
class CSSImportRuleImpl extends CSSRuleImpl {
  constructor(globalObject, args, privateData) {
    ...
    this.layerName = privateData.layerName !== undefined ? privateData.layerName : null;
    this.supportsText = privateData.supportsText !== undefined ? privateData.supportsText : null;
