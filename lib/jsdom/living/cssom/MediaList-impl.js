...
// https://github.com/csstree/csstree/issues/52. This is a compromise, and still not fully spec-complaint.
function parseSingleMedium(text) {
  ...
  try {
    ...
    return {
      ...
      canonical: csstree.generate(mql.children.first).toLowerCase()
    };
  } catch {
    return null;
  }
