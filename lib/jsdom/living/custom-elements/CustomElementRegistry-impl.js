...
class CustomElementRegistryImpl {
  ...
  define(name, constructor, options) {
    ...
    for (const candidate of this._globalObject._document._shadowIncludingInclusiveDescendants()) {
      if (
  ...
  upgrade(root) {
    for (const candidate of root._shadowIncludingInclusiveDescendants()) {
