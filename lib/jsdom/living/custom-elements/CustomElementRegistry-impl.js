...
const IDLFunction = require("../../../generated/idl/Function.js");
const HTMLUnknownElement = require("../../../generated/idl/HTMLUnknownElement");
...
class CustomElementRegistryImpl {
  ...
  define(name, constructor, options) {
    ...
    for (const candidate of treeHelpers.shadowIncludingInclusiveDescendantsIterator(document)) {
      if (
  ...
  upgrade(root) {
    for (const candidate of treeHelpers.shadowIncludingInclusiveDescendantsIterator(root)) {
