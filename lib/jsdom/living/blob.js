...
class Blob {
    ...
    if (parts) {
      ...
      for (let i = 0; i < l; i++) {
        ...
        if (part instanceof ArrayBuffer) {
          ...
          // a shortcut instead of going through new Buffer(String(part))
          buffer = part;
        } else {
  ...
  slice() {
    ...
    const blob = new Blob([], { type: arguments[2] === undefined ? this.type : String(arguments[2]) });
...
module.exports = { Blob, blobToBuffer };
