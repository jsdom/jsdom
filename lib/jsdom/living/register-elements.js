...
const mappings = {
  ...
  "http://www.w3.org/2000/svg": {
    ...
    SVGStyleElement: {
      file: require("./generated/SVGStyleElement.js"),
      tags: ["style"]
    },
    SVGUnknownElement: {
      file: require("./generated/SVGUnknownElement.js"),
      tags: []
    }
  }
};
  ...
  for (const ns of Object.keys(mappings)) {
    ...
    for (const interfaceName of Object.keys(interfaces)) {
      ...
      for (const tagName of tags) {
        DocumentImpl.implementation.prototype._elementBuilders[ns][tagName] = (document, elName) => {
          return file.create([], {
            core,
