...
exports.changeAttribute = function (element, attribute, value) {
  ...
  attribute._changeAttributeImpl(element, value);
};
...
exports.setAttributeValue = function (element, localName, value, prefix, namespace) {
  ...
  if (attribute === null) {
    const newAttribute = element._ownerDocument._createNode(NODE_TYPE.ATTRIBUTE_NODE, [], {
      namespace, namespacePrefix: prefix, localName, value
    });
...
exports.copyAttributeList = function (sourceElement, destElement) {
  ...
  for (const sourceAttr of sourceElement._attributes[INTERNAL].attributeList) {
    const destAttr = destElement._ownerDocument._createNode(NODE_TYPE.ATTRIBUTE_NODE, [], {
...
exports.attributeNames = function (element) {
  ...
  return element._attributes[INTERNAL].attributeList.map(attr => attr.name);
};
