...
function handleAttributeChanges(element, attribute, oldValue, value) {
  const { _localName, _namespace } = attribute;
  queueAttributeMutationRecord(element, _localName, _namespace, oldValue);
  ...
  element._attributeChangeSteps(_localName, oldValue, value, _namespace);
}
...
exports.changeAttribute = (element, attribute, value) => {
  ...
  handleAttributeChanges(element, attribute, oldValue, value);
};
...
exports.appendAttribute = function (element, attribute) {
  ...
  handleAttributeChanges(element, attribute, null, attribute._value);
};
...
exports.removeAttribute = function (element, attribute) {
  ...
  for (let i = 0; i < attributeList.length; ++i) {
    if (attributeList[i] === attribute) {
      ...
      handleAttributeChanges(element, attribute, attribute._value, null);
...
exports.replaceAttribute = function (element, oldAttr, newAttr) {
  ...
  for (let i = 0; i < attributeList.length; ++i) {
    if (attributeList[i] === oldAttr) {
      ...
      handleAttributeChanges(element, oldAttr, oldAttr._value, newAttr._value);
