...
exports.setAttributeValue = function (element, localName, value, prefix, namespace, windowObject) {
  ...
  if (attribute === null) {
    const newAttribute = attrGenerated.createImpl(windowObject, [], { namespace, namespacePrefix: prefix, localName, value });
