...
function structuredDeserialize(serialized, targetRealm, memory = new targetRealm.Map()) {
  ...
  if (serialized.type === "primitive") {
    ...
    switch (serialized.name) {
      case "EvalError": {
        prototype = targetRealm.EvalError.prototype;
        break;
      }

      case "RangeError": {
        prototype = targetRealm.RangeError.prototype;
        break;
      }

      case "ReferenceError": {
        prototype = targetRealm.ReferenceError.prototype;
        break;
      }

      case "SyntaxError": {
        prototype = targetRealm.SyntaxError.prototype;
        break;
      }

      case "TypeError": {
        prototype = targetRealm.TypeError.prototype;
        break;
      }

      case "URIError": {
        prototype = targetRealm.URIError.prototype;
        break;
      }

      default: {
        prototype = targetRealm.Error.prototype;
      }
    }
