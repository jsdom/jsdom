...
function structuredDeserialize(serialized, targetRealm, memory = new targetRealm.Map()) {
  ...
  if (serialized.type === "primitive") {
     ...
     */
    value = targetRealm.Boolean(serialized.booleanData);
    ...
    value = targetRealm.Number(serialized.numberData);
    ...
    value = targetRealm.BigInt(serialized.bigIntData);
    ...
    value = targetRealm.String(serialized.stringData);
