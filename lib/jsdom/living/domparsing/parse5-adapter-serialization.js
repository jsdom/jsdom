...
exports.getChildNodes = node => treeHelpers.childrenToArray(node);
...
// Node types
exports.isTextNode = node => node.nodeType === nodeTypes.TEXT_NODE || node.nodeType === nodeTypes.CDATA_SECTION_NODE;
