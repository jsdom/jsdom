...
const { fragmentSerialization, fragmentSerializationWithShadowRoots } = require("./serialization.js");
...
exports.implementation = class InnerHTMLImpl {
  ...
  getHTML(options = {}) {
    ...
    if (!serializableShadowRoots && (!shadowRoots || shadowRoots.length === 0)) {
      return fragmentSerialization(this, {
        outer: false,
        requireWellFormed: true,
        globalObject: this._globalObject
    ...
    return fragmentSerializationWithShadowRoots(this, {
      serializableShadowRoots: serializableShadowRoots === true,
