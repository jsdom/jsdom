...
const { removeStyleSheet } = require("../css/helpers/stylesheets");
...
const SelectorCache = require("../helpers/selector-cache");
...
class DocumentImpl extends NodeImpl {
  _selectorCache = new SelectorCache();
  ...
  _descendantRemoved(parent, child) {
    if (child.tagName === "STYLE") {
      if (child.sheet) {
        removeStyleSheet(child.sheet, child);
      }
    }
