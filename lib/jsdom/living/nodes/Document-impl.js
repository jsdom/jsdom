...
class DocumentImpl extends NodeImpl {
  constructor(args, privateData) {
    ...
    this[internalConstants.origin] = new whatwgURL.URL(urlOption).origin;
    ...
    this[internalConstants.lastModified] = toLastModifiedString(privateData.options.lastModified || new Date());
    ...
    this[internalConstants.strictSSL] = privateData.options.strictSSL;
  ...
  get origin() {
    return this[internalConstants.origin];
  }
  get location() {
  ...
  get lastModified() {
    return this[internalConstants.lastModified];
  }
  get images() {
