...
class DocumentImpl extends NodeImpl {
  constructor(globalObject, args, privateData) {
    ...
    this._implementation = DOMImplementation.createImpl(this._sdGlobalObject, [], {
      ownerDocument: this
    });
    ...
    this._location = Location.createImpl(this._sdGlobalObject, [], { relevantDocument: this });
    this._history = History.createImpl(this._sdGlobalObject, [], {
    ...
    this._domSelector = new DOMSelector(this._sdGlobalObject, this._ownerDocument, {
      domSymbolTree,
      idlUtils
    });
  ...
  get links() {
    return HTMLCollection.createImpl(this._sdGlobalObject, [], {
      element: this,
  ...
  createEvent(type) {
    ...
    const impl = eventWrapper.createImpl(this._sdGlobalObject, [""]);
    impl._initializedFlag = false;
    return impl;
  }

  createRange() {
    return Range.createImpl(this._sdGlobalObject, [], {
  ...
  createProcessingInstruction(target, data) {
    validateName(this._sdGlobalObject, target);
    ...
    return ProcessingInstruction.createImpl(this._sdGlobalObject, [], {
      ownerDocument: this,
      target,
      data
    });
  ...
  createCDATASection(data) {
    ...
    return CDATASection.createImpl(this._sdGlobalObject, [], {
      ownerDocument: this,
      data
    });
  }
  ...
  createTextNode(data) {
    return Text.createImpl(this._sdGlobalObject, [], {
      ownerDocument: this,
      data
    });
  }
  ...
  createComment(data) {
    return Comment.createImpl(this._sdGlobalObject, [], {
      ownerDocument: this,
      data
    });
  }
  ...
  createElement(localName, options) {
    validateName(this._sdGlobalObject, localName);
  ...
  createDocumentFragment() {
    return DocumentFragment.createImpl(this._sdGlobalObject, [], { ownerDocument: this });
  }
  ...
  createAttributeNS(namespace, name) {
    ...
    const extracted = validateAndExtract(this._sdGlobalObject, namespace, name);
  ...
  _createAttribute({
    ...
    return generatedAttr.createImpl(this._sdGlobalObject, [], {
      localName,
      value,
      namespace,
      namespacePrefix,
  ...
  createTreeWalker(root, whatToShow, filter) {
    return TreeWalker.createImpl(this._sdGlobalObject, [], { root, whatToShow, filter });
  }

  createNodeIterator(root, whatToShow, filter) {
    const nodeIterator = NodeIterator.createImpl(this._sdGlobalObject, [], { root, whatToShow, filter });
  ...
  get styleSheets() {
    if (!this._styleSheets) {
      this._styleSheets = StyleSheetList.createImpl(this._sdGlobalObject);
    }
