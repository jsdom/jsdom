...
class DocumentImpl extends NodeImpl {
  ...
  get hidden() {
    if (this._defaultView && idlUtils.implForWrapper(this._defaultView)._pretendToBeVisual) {
      return false;
    }
  ...
  getSelection() {
    return this._defaultView ? idlUtils.implForWrapper(this._defaultView)._selection : null;
  }
}
