...
class DocumentImpl extends NodeImpl {
  ...
  constructor(globalObject, args, privateData) {
    ...
    this._URL = parsed;
    this._origin = privateData.options.inheritedOrigin ?? whatwgURL.serializeURLOrigin(this._URL);
    // Keep opaque origins distinct even though their serialization is always "null".
    if (privateData.options.inheritedOriginIdentity !== undefined) {
      this._originIdentity = privateData.options.inheritedOriginIdentity;
