...
class DocumentImpl extends NodeImpl {
  ...
  constructor(globalObject, args, {
    ...
    this._URL = parsed;
    this._origin = whatwgURL.matchesAboutBlank(parsed) && parentOrigin ?
      parentOrigin :
    ...
    if (parsed.blobURLEntry) {
      this._originIdentity = parsed.blobURLEntry.environment._originIdentity;
    } else if (whatwgURL.matchesAboutBlank(parsed) && parentOriginIdentity !== undefined) {
      this._originIdentity = parentOriginIdentity;
    }
