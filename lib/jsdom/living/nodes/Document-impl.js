...
class DocumentImpl extends NodeImpl {
  ...
  get doctype() {
    for (const childNode of treeHelpers.childrenIterator(this)) {
  ...
  get links() {
    return HTMLCollection.createImpl(this._globalObject, [], {
      element: this,
      query: () => treeHelpers.treeToArray(this, {
  ...
  get #namedPropertyElements() {
    if (this.#namedPropertyElementsCache === null) {
      ...
      for (const element of treeHelpers.treeToArray(this, { filter: isNamedPropertyElement })) {
