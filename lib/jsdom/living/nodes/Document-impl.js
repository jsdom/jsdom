...
class DocumentImpl extends NodeImpl {
  ...
  _isNodeType(arg, nodeType) {
    const impl = this._nodeBuilders[nodeType];
    return !!impl && impl.isImpl(arg);
  }

  _createNode(nodeType, constructorArgs, privateData) {
    const impl = this._nodeBuilders[nodeType];
    ...
    return impl.createImpl(constructorArgs, privateData);
  }
  ...
  createProcessingInstruction(target, data) {
    ...
    return this._createNode(NODE_TYPE.PROCESSING_INSTRUCTION_NODE, [], {
      core: this._core,
      ownerDocument: this,
      target,
      data
  ...
  createCDATASection(data) {
    ...
    return this._createNode(NODE_TYPE.CDATA_SECTION_NODE, [], {
      core: this._core,
      ownerDocument: this,
      data
    });
  ...
  createTextNode(data) {
    return this._createNode(NODE_TYPE.TEXT_NODE, [], {
      core: this._core,
      ownerDocument: this,
      data
    });
  ...
  createComment(data) {
    return this._createNode(NODE_TYPE.COMMENT_NODE, [], {
      core: this._core,
      ownerDocument: this,
      data
    });
  ...
  createDocumentFragment() {
    return this._createNode(NODE_TYPE.DOCUMENT_FRAGMENT_NODE, [], { ownerDocument: this });
  }
  ...
  createAttribute(localName) {
    ...
    return this._createNode(NODE_TYPE.ATTRIBUTE_NODE, [], { localName });
  }
  ...
  createAttributeNS(namespace, name) {
    ...
    return this._createNode(NODE_TYPE.ATTRIBUTE_NODE, [], {
...
DocumentImpl.prototype._nodeBuilders = Object.create(null);
