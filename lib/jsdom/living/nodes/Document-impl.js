...
class DocumentImpl extends NodeImpl {
  constructor(args, privateData) {
	...
	this._afterCreateElement = privateData.options.afterCreateElement;
  ...
  _createElementWithCorrectElementInterface(localName, namespace) {
    ...
    if (this._elementBuilders[namespace] && this._elementBuilders[namespace][localName]) {
	  const element = this._elementBuilders[namespace][localName](this, localName, namespace);
	  if (element && this._afterCreateElement) {
		  this._afterCreateElement(element);
	  }
	  return element;
