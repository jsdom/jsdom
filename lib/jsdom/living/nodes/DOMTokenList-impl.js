...
class DOMTokenListImpl {
  constructor(constructorArgs, privateData) {
    ...
    this._dirty = true;
    this._globalObject = privateData.globalObject;
  }
  ...
  _updateSteps() {
    ...
    setAttributeValue(this._element, this._attributeLocalName, this._tokenSet.serialize(), undefined, undefined, this._globalObject);
  }
  ...
  set value(V) {
    setAttributeValue(this._element, this._attributeLocalName, V, undefined, undefined, this._globalObject);
  }
}
