...
const HTMLFormControlsCollection = require("../../../generated/idl/HTMLFormControlsCollection");
const { notImplementedMethod } = require("../../browser/not-implemented");
const SubmitEvent = require("../../../generated/idl/SubmitEvent");
...
class HTMLFormElementImpl extends HTMLElementImpl {
  _getSubmittableElementNodes() {
    return this._getFormControlSearchRoot()._inclusiveDescendantsToArray(node => {
