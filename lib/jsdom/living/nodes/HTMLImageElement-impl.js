...
class HTMLImageElementImpl extends HTMLElementImpl {
  constructor(...args) {
    super(...args);
    this._currentRequestState = REQUEST_STATE_UNAVAILABLE;
  }
  ...
  get complete() {
    ...
    return srcAttributeValue === null ||
      srcAttributeValue === "" ||
      this._currentRequestState === REQUEST_STATE_BROKEN ||
      this._currentRequestState === REQUEST_STATE_COMPLETELY_AVAILABLE;
  }
