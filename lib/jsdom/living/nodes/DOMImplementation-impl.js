...
class DOMImplementationImpl {
  ...
  createDocument(namespace, qualifiedName, doctype) {
    ...
    const document = Document.createImpl([], {
      core: this.core,
      options: { parsingMode: "xml", encoding: "UTF-8", defaultEncoding: this._ownerDocument._defaultEncoding }
    });
  ...
  createHTMLDocument(title) {
    ...
    const document = Document.createImpl([], {
      core: this.core,
      options: { parsingMode: "html", encoding: "UTF-8", defaultEncoding: this._ownerDocument._defaultEncoding }
    });
