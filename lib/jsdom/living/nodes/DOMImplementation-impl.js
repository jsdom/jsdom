...
class DOMImplementationImpl {
  ...
  createDocumentType(qualifiedName, publicId, systemId) {
    validateNames.qname(this._sdGlobalObject, qualifiedName);

    return DocumentType.createImpl(this._sdGlobalObject, [], {
  ...
  createDocument(namespace, qualifiedName, doctype) {
    ...
    const document = documents.createImpl(this._sdGlobalObject, {
      contentType,
      parsingMode: "xml",
      encoding: "UTF-8"
    });
  ...
  createHTMLDocument(title) {
    ...
    const doctype = DocumentType.createImpl(this._sdGlobalObject, [], {
