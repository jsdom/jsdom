...
const XMLDocument = require("../generated/XMLDocument");
const { HTML_NS, SVG_NS } = require("../helpers/namespaces");

exports.implementation = class DOMImplementationImpl {
  ...
  createDocument(namespace, qualifiedName, doctype) {
    ...
    const document = this._createDocument(this._globalObject, {
      contentType,
      parsingMode: "xml",
      encoding: "UTF-8"
    });
  ...
  _createDocument(globalObject, options = {}, type = options.parsingMode || null) {
    switch (type) {
      case "xml":
