  ...
  _addFeature(feature, version) {
    ...
    if (version) {
      ...
      if (feature === "processexternalresources" &&
        ...
        const windowImpl = this._ownerDocument._defaultView;
        windowImpl._globalProxy = vm.runInContext("this", this._ownerDocument._global);
        windowImpl[idlUtils.wrapperSymbol] = windowImpl._globalProxy;
      }
    }
  }
