...
class HTMLElementImpl extends ElementImpl {
  ...
  attachShadow(options) {
    switch (options.mode) {
      case 'open': {
        const instance = idlUtils.wrapperForImpl(this);
        instance.shadowRoot = instance.ownerDocument.createDocumentFragment();
      }
...
idlUtils.mixin(HTMLElementImpl.prototype, GlobalEventHandlersImpl.prototype);
