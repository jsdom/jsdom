...
const ElementInternals = require("../../../generated/idl/ElementInternals");
...
class HTMLElementImpl extends ElementImpl {
  ...
  get translate() {
    ...
    if (translateAttr !== null) {
      ...
      if (translateAttrString === "yes" || translateAttrString === "") {
        return true;
    ...
    return this.parentElement === null || this.parentElement.translate;
  }
  set translate(value) {
    if (value === true) {
  ...
  _attrModified(name, value, oldValue) {
    if (name === "style" && value !== oldValue) {
      CSSStyleProperties.convert(this._globalObject, this._style)._change(name, value, null);
