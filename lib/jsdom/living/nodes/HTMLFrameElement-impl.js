...
const window = require("../../browser/Window.js");
const HTMLElementImpl = require("./HTMLElement-impl.js").implementation;
const { evaluateJavaScriptURL } = require("../window/navigation.js");
const { parseIntoDocument } = require("../../browser/parser.js");
const { documentBaseURL } = require("../helpers/document-base-url.js");
const { fireAnEvent } = require("../helpers/events.js");
const { getAttributeValue } = require("../attributes.js");
