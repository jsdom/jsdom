...
function loadFrame(frame) {
  ...
  applyDocumentFeatures(idlUtils.wrapperForImpl(contentDoc), parentDoc.implementation._features);
...
const Window = require("../generated/Window");
