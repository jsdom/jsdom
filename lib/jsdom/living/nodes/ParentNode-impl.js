...
class ParentNodeImpl {
  ...
  querySelector(selectors) {
    ...
    return idlUtils.implForWrapper(selery.querySelector(idlUtils.wrapperForImpl(this), selectors));
  }
  ...
  querySelectorAll(selectors) {
    ...
    const list = selery.querySelectorAll(idlUtils.wrapperForImpl(this), selectors);
