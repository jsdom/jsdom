...
const { addSelery } = require("../helpers/selectors");
...
class ParentNodeImpl {
  ...
  querySelector(selectors) {
    ...
    const matcher = addSelery(this);
    return idlUtils.implForWrapper(matcher.querySelector(idlUtils.wrapperForImpl(this), selectors));
  }
  ...
  querySelectorAll(selectors) {
    ...
    const matcher = addSelery(this);
    const list = matcher.querySelectorAll(idlUtils.wrapperForImpl(this), selectors);
