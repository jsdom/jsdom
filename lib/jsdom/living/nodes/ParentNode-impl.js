...
const { addDomSelector } = require("../helpers/selectors");
...
class ParentNodeImpl {
  ...
  querySelector(selectors) {
    ...
    const matcher = addDomSelector(this);
    return idlUtils.implForWrapper(matcher.querySelector(selectors, idlUtils.wrapperForImpl(this)));
  }
  ...
  querySelectorAll(selectors) {
    ...
    const matcher = addDomSelector(this);
    const list = matcher.querySelectorAll(selectors, idlUtils.wrapperForImpl(this));
