...
class ParentNodeImpl {
  ...
  querySelector(selectors) {
    ...
    const node = domSelector.querySelector(selectors, idlUtils.wrapperForImpl(this));
    console.log(node);
    return idlUtils.implForWrapper(node);
  }
  ...
  querySelectorAll(selectors) {
    ...
    const list = domSelector.querySelectorAll(selectors, idlUtils.wrapperForImpl(this));
