...
class ParentNodeImpl {
  ...
  replaceChildren(...nodes) {
    ...
    const removedNodes = domSymbolTree.childrenToArray(this);
    const childrenToExclude = this.nodeType === NODE_TYPE.DOCUMENT_NODE ? new Set(removedNodes) : undefined;
    this._preInsertValidity(node, null, childrenToExclude);
    this._replaceAll(node, removedNodes);
  }
