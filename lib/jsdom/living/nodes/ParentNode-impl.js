...
class ParentNodeImpl {
  ...
  querySelector(selectors) {
    ...
    if (!this._ownerDocument._selery) {
      this._ownerDocument._selery = selery;
    }
    return idlUtils.implForWrapper(this._ownerDocument._selery.querySelector(idlUtils.wrapperForImpl(this), selectors));
  }
  ...
  querySelectorAll(selectors) {
    ...
    const list = this._ownerDocument._selery.querySelectorAll(idlUtils.wrapperForImpl(this), selectors);
