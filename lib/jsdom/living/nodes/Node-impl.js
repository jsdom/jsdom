...
const { releaseCaptureForDisconnectedElement } = require("../helpers/pointer-capture");
...
class NodeImpl extends EventTargetImpl {
  ...
  * _liveRanges() {
  ...
  _detach() {
    ...
    if (this.nodeType === NODE_TYPE.ELEMENT_NODE) {
      releaseCaptureForDisconnectedElement(this);
    }
