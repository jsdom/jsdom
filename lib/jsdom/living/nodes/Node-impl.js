...
class NodeImpl extends EventTargetImpl {
  ...
  get childNodes() {
    if (!this._childNodesList) {
      this._childNodesList = NodeList.createImpl(this._sdGlobalObject, [], {
        element: this,
  ...
  cloneNode(deep) {
    if (isShadowRoot(this)) {
      throw DOMException.create(this._sdGlobalObject, ["ShadowRoot nodes are not clonable.", "NotSupportedError"]);
    }
