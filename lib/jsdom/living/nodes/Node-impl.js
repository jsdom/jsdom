...
class NodeImpl extends EventTargetImpl {
  ...
  * _liveRanges() {
  ...
  _removingSteps() {
    ...
    if (activeElement && isHostInclusiveAncestor(this, activeElement)) {
      ...
      const fallbackTarget = this._ownerDocument.body || this._ownerDocument.documentElement || this._ownerDocument;
      this._ownerDocument._lastFocusedElement = fallbackTarget;
