...
const { changeAttribute } = require("../elements.js");
...
exports.implementation = class NodeImpl extends EventTargetImpl {
  ...
  set nodeValue(value) {
    ...
    switch (this.nodeType) {
      case NODE_TYPE.ATTRIBUTE_NODE: {
        exports.setAnExistingAttributeValue(this, value);
        break;
      }
      case NODE_TYPE.TEXT_NODE:
      case NODE_TYPE.CDATA_SECTION_NODE: // CDATASection is a subclass of Text
