...
const { simultaneousIterators } = require("../../utils.js");
const NODE_TYPE = require("../node-type.js");
const NODE_DOCUMENT_POSITION = require("../node-document-position.js");
const { clone, locateNamespacePrefix, locateNamespace } = require("../node.js");
const { setAnExistingAttributeValue } = require("../attributes.js");

const NodeList = require("../generated/NodeList.js");

const { nodeRoot, nodeLength } = require("../helpers/node.js");
...
const { queueTreeMutationRecord } = require("../helpers/mutation-observers.js");
const { enqueueCECallbackReaction, tryUpgradeElement } = require("../helpers/custom-elements.js");
const {
