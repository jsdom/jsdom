...
const FileList = require("../generated/FileList.js");
...
const ValidityState = require("../generated/ValidityState.js");
const { mixin } = require("../../utils.js");
const { domSymbolTree, cloningSteps } = require("../helpers/internal-constants.js");
const { getLabelsForLabelable, formOwner } = require("../helpers/form-controls.js");
...
const {
  ...
  isValidAbsoluteURL,
  sanitizeValueByType
} = require("../helpers/form-controls.js");
const {
...
const { isDate } = require("../helpers/dates-and-times.js");
const {
  convertStringToNumberByType,
  convertStringToDateByType,
  serializeDateByType,
  convertNumberToStringByType
} = require("../helpers/number-and-date-inputs.js");
