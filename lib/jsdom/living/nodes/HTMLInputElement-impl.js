...
class HTMLInputElementImpl extends HTMLElementImpl {
  ...
  get validity() {
    if (!this._validity) {
      ...
      this._validity = ValidityState.createImpl({
        ...
        valueMissing: () => this.willValidate && this.hasAttribute("required") &&
  ...
  get validationMessage() {
    ...
    if (!this.validity.valid && (!message || message === "")) {
      return "The input element does not satisfy its constraints";
    }
    return "";
  }
