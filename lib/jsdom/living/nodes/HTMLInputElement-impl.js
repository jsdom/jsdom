...
const { reflectLimitedToNonNegative, reflectLimitedToNonNegativeGreaterThanZero } = require("../helpers/reflection");
const {
  isDisabled,
  isValidEmailAddress,
  isValidAbsoluteURL,
...
reflectLimitedToNonNegative(HTMLInputElementImpl.prototype, "maxLength", "maxlength");
reflectLimitedToNonNegative(HTMLInputElementImpl.prototype, "minLength", "minlength");
reflectLimitedToNonNegativeGreaterThanZero(HTMLInputElementImpl.prototype, "size", "size", 20);
