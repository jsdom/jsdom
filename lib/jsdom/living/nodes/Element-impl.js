...
class ElementImpl extends NodeImpl {
  ...
  set outerHTML(markup) {
    ...
    const fragment = parseFragment(markup, parent, this._globalObject);
  ...
  set innerHTML(markup) {
    const fragment = parseFragment(markup, this, this._globalObject);
  ...
  setAttributeNS(namespace, name, value) {
    ...
    attributes.setAttributeValue(this, extracted.localName, value, extracted.prefix, extracted.namespace, this._globalObject);
  }
  ...
  insertAdjacentHTML(position, text) {
    ...
    const fragment = parseFragment(text, context, this._globalObject);
