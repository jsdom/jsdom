...
const pointerCapture = require("../helpers/pointer-capture");
...
class ElementImpl extends NodeImpl {
  ...
  setPointerCapture(pointerId) {
    pointerCapture.setPointerCapture(this, pointerId);
  }

  releasePointerCapture(pointerId) {
    pointerCapture.releasePointerCapture(this, pointerId);
  }

  hasPointerCapture(pointerId) {
    return pointerCapture.hasPointerCapture(this, pointerId);
  }
