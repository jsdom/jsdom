    ...
    switch (position) {
      ...
      case "afterend":
        ...
        if (context === null || context.nodeType === NODE_TYPE.DOCUMENT_NODE) {
          throw new DOMException(DOMException.NO_MODIFICATION_ALLOWED_ERR, "Modifications are not allowed for this" +
          " document");
        }
        break;
      ...
      default:
        throw new DOMException(DOMException.SYNTAX_ERR, "The value provided is not one of 'beforebegin', 'afterbegin'" +
        ", 'beforeend', or 'afterend'");
    }

    if (!context || context.nodeType !== NODE_TYPE.ELEMENT_NODE) {
      context = this.ownerDocument.createElementNS("http://www.w3.org/1999/xhtml", "body");
    }

    const fragment = context.ownerDocument.createElement("template");
