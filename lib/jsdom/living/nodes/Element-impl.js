...
class ElementImpl extends NodeImpl {
  ...
  setAttribute(name, value) {
    ...
    if (attribute === null) {
      const newAttr = this._ownerDocument._createNode(NODE_TYPE.ATTRIBUTE_NODE, [], { localName: name, value });
  ...
  setAttributeNode(attr) {
    if (!this._ownerDocument._isNodeType(attr, NODE_TYPE.ATTRIBUTE_NODE)) {
