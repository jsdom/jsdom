"use strict";
const { addNwsapi } = require("../helpers/selectors.js");
...
const { parseFragment } = require("../../browser/parser.js");
...
const NamedNodeMap = require("../generated/NamedNodeMap.js");
const validateNames = require("../helpers/validate-names.js");
const { asciiLowercase, asciiUppercase } = require("../helpers/strings.js");
...
const SlotableMixinImpl = require("./Slotable-impl.js").implementation;
const NonDocumentTypeChildNode = require("./NonDocumentTypeChildNode-impl.js").implementation;
const ShadowRoot = require("../generated/ShadowRoot.js");
const Text = require("../generated/Text.js");
const { isValidHostElementName } = require("../helpers/shadow-dom.js");
const { isValidCustomElementName, lookupCEDefinition } = require("../helpers/custom-elements.js");
