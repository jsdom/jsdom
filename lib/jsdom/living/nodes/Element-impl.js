...
class ElementImpl extends NodeImpl {
  ...
  closest(selectors) {
    ...
    return this._ownerDocument._selery.closest(idlUtils.wrapperForImpl(this), selectors);
  }
}
...
ElementImpl.prototype.matches = function (selectors) {
  ...
  return this._ownerDocument._selery.matches(idlUtils.wrapperForImpl(this), selectors);
};
