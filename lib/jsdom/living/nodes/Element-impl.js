...
class ElementImpl extends NodeImpl {
  ...
  _attach() {
    windowProperties.elementAttached(this);
  ...
  _detach() {
    ...
    windowProperties.elementDetached(this);
  ...
  get attributes() {
    if (!this._attributes) {
      this._attributes = NamedNodeMap.createImpl(this._sdGlobalObject, [], {
        element: this
      });
    }
  ...
  get outerHTML() {
    return fragmentSerialization(this, {
      ...
      globalObject: this._sdGlobalObject
    });
  }
  ...
  get classList() {
    if (this._classList === undefined) {
      this._classList = DOMTokenList.createImpl(this._sdGlobalObject, [], {
        element: this,
  ...
  setAttribute(name, value) {
    validateNames.name(this._sdGlobalObject, name);
  ...
  setAttributeNS(namespace, name, value) {
    const extracted = validateNames.validateAndExtract(this._sdGlobalObject, namespace, name);
  ...
  toggleAttribute(qualifiedName, force) {
    validateNames.name(this._sdGlobalObject, qualifiedName);
  ...
  attachShadow(init) {
    ...
    const shadow = ShadowRoot.createImpl(this._sdGlobalObject, [], {
  ...
  insertAdjacentText(where, data) {
    const text = Text.createImpl(this._sdGlobalObject, [], { data, ownerDocument: this._ownerDocument });
