...
const { closest, matches, querySelector, querySelectorAll } = require("../helpers/selector");
...
class ElementImpl extends NodeImpl {
  ...
  closest(selectors) {
    return closest(selectors, idlUtils.wrapperForImpl(this), this._globalObject);
  }

  matches(selectors) {
    return matches(selectors, idlUtils.wrapperForImpl(this), this._globalObject);
  }
