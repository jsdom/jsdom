...
const { matchElementAgainstSelectors, parseGrammar } = require("@cdoublev/css");
...
class ElementImpl extends NodeImpl {
  ...
  matches(selectors) {
    ...
    const res = Boolean(matchElementAgainstSelectors(this, selectors, context));
