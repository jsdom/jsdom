...
ElementImpl.prototype.closest = memoizeQuery(function (selectors) {
  // https://dom.spec.whatwg.org/#dom-element-closest
  let el = this;

  while (el.nodeType === NODE_TYPE.ELEMENT_NODE) {
    if (ElementImpl.prototype.matches.call(el, selectors)) {
      return el;
    }
    el = el.parentNode;
  }
