...
class HTMLOrSVGElementImpl {
  ...
  focus() {
    ...
    if (previous) {
      ...
      if (ownerDocument._lastFocusedElement !== null) {
        return;
      }
      ...
      if (frameElement) {
        ...
        const frameLastFocusedElement = frameOwnerDoc._lastFocusedElement;
        
        frameOwnerDoc._lastFocusedElement = null;
        frameOwnerDoc._clearDOMSelector();

        focusing.fireFocusEventWithTargetAdjustment("blur", frameLastFocusedElement, null);
        if (frameOwnerDoc._lastFocusedElement !== null) {
          return;
        }
