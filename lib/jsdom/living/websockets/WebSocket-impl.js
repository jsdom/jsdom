...
class WebSocketImpl extends EventTargetImpl {
  constructor(globalObject, args, privateData) {
    ...
    this._ownerDocument = this._globalImpl.document;
    this._globalProxy = this._globalImpl._globalProxy;
    ...
    let openSocketsForWindow = openSockets.get(this._globalProxy);
    if (openSocketsForWindow === undefined) {
      openSocketsForWindow = new Set();
      openSockets.set(this._globalProxy, openSocketsForWindow);
    }
  ...
  _onConnectionClosed(code, reason) {
    const openSocketsForWindow = openSockets.get(this._globalProxy);
