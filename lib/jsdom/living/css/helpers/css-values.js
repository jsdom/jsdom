  ...
  switch (type) {
    ...
    case AST_TYPES.IDENTIFIER: {
      if (systemColors.has(name)) {
        ...
        return resolveSystemColorValue(name, opt.colorScheme);
      }
...
/**
 * Resolves a system color value
 *
 * @param {Array<object>} value - The AST node array containing the system color value.
 * @param {string} colorScheme - The color scheme.
 * @returns {string} - resolved system color.
 */
