...
function replaceEmptyValueAndKeyword(property, value, elementImpl, { inherit, initial, longhands }) {
  if (value === "") {
    if (longhands) {
      return "";
...
exports.replaceEmptyValueAndKeyword = replaceEmptyValueAndKeyword;
