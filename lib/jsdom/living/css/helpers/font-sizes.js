...
function resolveLengthInPixels(elementImpl, size, dimension, isFontSize) {
  ...
  if (absoluteFontSize.has(size)) {
    ...
    // A percentage prevents full reduction, e.g. calc(100% - 1rem) resolves to calc(100% - 16px).
    // The lengths within the math function are still absolutized at computed-value time.
