...
function getAllSystemColors() {
  const sysColors = new Map([...systemColors]);
  for (const [key, aliasOf] of deprecatedAliases) {
    const value = systemColors.get(aliasOf);
    sysColors.set(key, value);
  }
  return sysColors;
}
...
// TODO: Remove later.
exports.deprecatedAliases = deprecatedAliases;
