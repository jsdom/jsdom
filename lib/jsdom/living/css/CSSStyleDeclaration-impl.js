...
class CSSStyleDeclarationImpl {
  ...
  #resolveLonghand(property, value, { caseSensitive, dimensionTypes, isColor }) {
    ...
    if (isColor) {
      ...
      if (lengthType) {
        const dimension = this.#ownerNode !== this.#ownerNode._ownerDocument.documentElement && options.dimension ?
          options.dimension :
          {};
        const isFontSize = property === "font-size";
        const resolvedValue = fontSizes.resolveLengthInPixels(this.#ownerNode, value, dimension, isFontSize);
