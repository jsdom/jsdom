...
class CSSStyleDeclarationImpl {
   ...
   * @returns {string} The computed value.
   */
  _resolveLonghandPropertyValue(property, value, { caseSensitive, functionTypes = {} }) {
  ...
  _prepareComputedValueOpts() {
    ...
    const previousColorScheme = this.#computedValueOpts.colorScheme;
    ...
    if (
      ...
      (previousColorScheme && previousColorScheme !== colorScheme)
    ) {
