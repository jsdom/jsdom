...
class CSSStyleDeclarationImpl {
  ...
  #prepareComputedValueOpts() {
    ...
    if (
      ...
      this.#computedValueOpts._rawColorScheme === rawColorScheme &&
      this.#computedValueOpts._rawColor === rawColor
    ) {
    ...
    this.#computedValueOpts.colorScheme = colorScheme;
    // Cache color-scheme value.
    this.#cachedPropertyValues.set("color-scheme", colorScheme);
    ...
    // NOTE: Do not cache currentColor as the color property value.
