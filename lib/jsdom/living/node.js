...
module.exports = function (core) {
  ...
  function getNodeParent(node) {
    ...
    switch (node.nodeType) {
      ...
      case core.Node.ATTRIBUTE_NODE:
        ...
        return domSymbolTree.parent(node);
  ...
  function isAncestor(node, otherNode) {
    var parentNode = node.nodeType === node.ATTRIBUTE_NODE ? domSymbolTree.parent(node) : node.parentNode;
  ...
  function followingOrPreceding(current, node, otherNode) {
    ...
    for (const child of domSymbolTree.childrenIterator(current)) {
      let result;
  ...
  defineGetter(core.Node.prototype, "parentElement", function () {
    ...
    return parentNode !== null && parentNode.nodeType === core.Node.ELEMENT_NODE ? parentNode : null;
  });
...
module.exports.clone = function (core, node, document, cloneChildren) {
  ...
  switch (node.nodeType) {
    ...
    case core.Node.DOCUMENT_TYPE_NODE:
      copy = new core.DocumentType(document, node._name, node._publicId, node._systemId);
      break;
