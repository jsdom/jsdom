...
const attrGenerated = require("./generated/Attr.js");
...
function copyAttributeList(sourceElement, destElement) {
  ...
  for (const sourceAttr of sourceElement._attributeList) {
    ...
    attributes.appendAttribute(destElement, destAttr);
  }
}
