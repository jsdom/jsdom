"use strict";
const { appendAttribute } = require("./attributes.js");
const NODE_TYPE = require("./node-type.js");

const orderedSetParse = require("./helpers/ordered-set.js").parse;
const { createElement } = require("./helpers/create-element.js");
const { HTML_NS, XMLNS_NS } = require("./helpers/namespaces.js");
const { cloningSteps, domSymbolTree } = require("./helpers/internal-constants.js");
const { asciiCaseInsensitiveMatch, asciiLowercase } = require("./helpers/strings.js");
