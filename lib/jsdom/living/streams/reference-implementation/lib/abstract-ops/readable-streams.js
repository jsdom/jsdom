...
function SetUpReadableByteStreamController(globalObject, stream, controller, startAlgorithm, pullAlgorithm, cancelAlgorithm,
...
function SetUpReadableByteStreamControllerFromUnderlyingSource(
  ...
  SetUpReadableByteStreamController(
    globalObject, stream, controller, startAlgorithm, pullAlgorithm, cancelAlgorithm, highWaterMark, autoAllocateChunkSize
  );
}
