...
exports.implementation = class ReadableStreamImpl {
  constructor(globalObject, [underlyingSource, strategy]) {
    this._globalObject = globalObject; // TODO where should this go?
    ...
    if (underlyingSourceDict.type === 'bytes') {
      ...
      aos.SetUpReadableByteStreamControllerFromUnderlyingSource(
        this._globalObject, this, underlyingSource, underlyingSourceDict, highWaterMark
      );
    } else {
      ...
      aos.SetUpReadableStreamDefaultControllerFromUnderlyingSource(
        this._globalObject, this, underlyingSource, underlyingSourceDict, highWaterMark, sizeAlgorithm
      );
    }
  }
  ...
  pipeThrough(transform, options) {
    ...
    const promise = aos.ReadableStreamPipeTo(
      this._globalObject, this, transform.writable, options.preventClose, options.preventAbort, options.preventCancel, options.signal
    );
  ...
  pipeTo(destination, options) {
    ...
    return aos.ReadableStreamPipeTo(
      this._globalObject, this, destination, options.preventClose, options.preventAbort, options.preventCancel, options.signal
    );
  }
