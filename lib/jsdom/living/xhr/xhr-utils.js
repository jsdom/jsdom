 ...
 *
 * We use the callback-based dispatch() API instead of the simpler request() API because
 * request() doesn't expose statusText: https://github.com/nodejs/undici/issues/4783
 */
