...
class XMLHttpRequestImpl extends XMLHttpRequestEventTargetImpl {
  constructor(globalObject) {
    ...
    this.upload = XMLHttpRequestUpload.createImpl(globalObject);
    ...
    this.flag = {
      ...
      strictSSL: this._globalImpl._resourceLoader._strictSSL,
      proxy: this._globalImpl._resourceLoader._proxy,
      cookieJar: _ownerDocument._cookieJar,
      encoding: _ownerDocument._encoding,
      origin: this._globalImpl._origin,
      userAgent: this._globalImpl.navigator.userAgent
    };
