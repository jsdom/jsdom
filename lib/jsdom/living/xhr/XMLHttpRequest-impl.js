...
const { implementation: XMLHttpRequestEventTargetImpl } = require("./XMLHttpRequestEventTarget-impl");
...
class XMLHttpRequest extends XMLHttpRequestEventTargetImpl {
  constructor(window) {
    ...
    /** @type {DocumentImpl} */
    this._ownerDocument = idlUtils.implForWrapper(window.document);
  ...
  /** @param {DocumentImpl | BodyInitImpl} body */
  send(body) {
