...
class XMLHttpRequestImpl extends XMLHttpRequestEventTargetImpl {
  constructor(window) {
    ...
    Object.setPrototypeOf(this.flag, null);
  ...
  set responseType(responseType) {
    const { flag } = this;
    if (this.readyState === XMLHttpRequestImpl.LOADING || this.readyState === XMLHttpRequestImpl.DONE) {
      throw DOMException.create(this._globalObject, ["The object is in an invalid state.", "InvalidStateError"]);
    }
    if (this.readyState === XMLHttpRequestImpl.OPENED && flag.synchronous) {
  ...
  get response() {
    ...
    switch (this.responseType) {
      ...
      case "json": {
        if (this.readyState !== XMLHttpRequestImpl.DONE || !responseBuffer) {
          res = null;
        }
  ...
  get responseXML() {
    ...
    if (this.readyState !== XMLHttpRequestImpl.DONE) {
      return null;
    }
  ...
  abort() {
    ...
    if (properties.abortError) {
      ...
      this.readyState = XMLHttpRequestImpl.DONE;
      properties.send = false;
      xhrUtils.setResponseToNetworkError(this);
      return;
    }

    if ((this.readyState === XMLHttpRequestImpl.OPENED && properties.send) ||
        this.readyState === XMLHttpRequestImpl.HEADERS_RECEIVED ||
        this.readyState === XMLHttpRequestImpl.LOADING) {
  ...
  getAllResponseHeaders() {
    ...
    if (readyState === XMLHttpRequestImpl.UNSENT || readyState === XMLHttpRequestImpl.OPENED) {
      return "";
    }
  ...
  open(method, uri, asynchronous, user, password) {
    ...
    this.responseURL = "";
    readyStateChange(this, XMLHttpRequestImpl.OPENED);
  }

  overrideMimeType(mime) {
    const { readyState } = this;
    if (readyState === XMLHttpRequestImpl.LOADING || readyState === XMLHttpRequestImpl.DONE) {
      throw DOMException.create(this._globalObject, ["The object is in an invalid state.", "InvalidStateError"]);
    }
  ...
  send(body) {
    ...
    if (flag.synchronous) {
      ...
      if (resProp.error) {
        ...
        readyStateChange(this, XMLHttpRequestImpl.DONE);
      ...
      if (this.timeout > 0) {
        ...
        properties.timeoutFn = () => {
          client.abort();
          if (!(this.readyState === XMLHttpRequestImpl.UNSENT ||
              (this.readyState === XMLHttpRequestImpl.OPENED && !properties.send) ||
              this.readyState === XMLHttpRequestImpl.DONE)) {
            properties.send = false;
...
Object.defineProperty(XMLHttpRequestImpl, "UNSENT", { value: 0, enumerable: true });
Object.defineProperty(XMLHttpRequestImpl, "OPENED", { value: 1, enumerable: true });
Object.defineProperty(XMLHttpRequestImpl, "HEADERS_RECEIVED", { value: 2, enumerable: true });
Object.defineProperty(XMLHttpRequestImpl, "LOADING", { value: 3, enumerable: true });
Object.defineProperty(XMLHttpRequestImpl, "DONE", { value: 4, enumerable: true });

Object.defineProperty(XMLHttpRequestImpl.prototype, "UNSENT", { value: 0, enumerable: true });
Object.defineProperty(XMLHttpRequestImpl.prototype, "OPENED", { value: 1, enumerable: true });
Object.defineProperty(XMLHttpRequestImpl.prototype, "HEADERS_RECEIVED", { value: 2, enumerable: true });
Object.defineProperty(XMLHttpRequestImpl.prototype, "LOADING", { value: 3, enumerable: true });
Object.defineProperty(XMLHttpRequestImpl.prototype, "DONE", { value: 4, enumerable: true });
...
function receiveResponse(xhr, response) {
  ...
  properties.responseXMLCache = null;
  readyStateChange(xhr, XMLHttpRequestImpl.HEADERS_RECEIVED);
  ...
  properties.client.on("data", chunk => {
    ...
    if (xhr.readyState === XMLHttpRequestImpl.HEADERS_RECEIVED) {
      xhr.readyState = XMLHttpRequestImpl.LOADING;
    }
    fireAnEvent("readystatechange", xhr);
  ...
  properties.client.on("end", () => {
    ...
    properties.client = null;
    fireAnEvent("progress", xhr, ProgressEvent, progressObj);
    readyStateChange(xhr, XMLHttpRequestImpl.DONE);
