...
process.stdin.on("end", () => {
  ...
  xhrImpl._httpAgent = xhrUtils.createAgentFromSerializedOptions(flag.httpAgentOptions);
  xhrImpl._httpsAgent = xhrUtils.createAgentFromSerializedOptions(flag.httpsAgentOptions);
  const { properties } = xhrImpl;
  xhrImpl.readyState = xhrUtils.READY_STATES.OPENED;
  try {
