        ...
        switch (format) {
          ...
          case "dataUrl":
            ...
            if (contentType && contentType.isText()) {
              const decoded = decodeString(data, contentType, "UTF-8", false);
              if (decoded.charset !== contentType.get("charset")) {
            ...
            break;
          case "text":
            self.result = decodeString(data, null, encoding, false).data;
            break;
        }
