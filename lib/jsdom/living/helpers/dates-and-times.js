...
// Always the shortest string for the given time, as a valid normalized local date and time string
// requires.
function serializeTime({ hour, minute, second, millisecond }) {
  ...
  const millisecondStr = `${millisecond}`.padStart(3, "0").replace(/0+$/u, "");
