...
function constructProxyHost(uriObject) {
  ...
  console.log("tunnel.js", protocol, port);
...
function constructProxyHeaderWhiteList(headers, proxyHeaderWhiteList) {
  ...
  console.log("constructProxyHeaderWhiteList");
...
function constructTunnelOptions(request, proxyHeaders) {
  ...
  console.log("constructTunnelOptions");
...
function constructTunnelFnName(uri, proxy) {
  ...
  console.log("constructTunnelFnName");
...
function getTunnelFn(request) {
  ...
  console.log("getTunnelFn, which uses the tunnel module");
...
Tunnel.prototype.setup = function (options) {
  ...
  if (!request.proxy || !request.tunnel) {
    console.log("tunnel setup return false");
    return false;
  }
  ...
  console.log("tunnel setup return true");
  return true;
};
