...
module.exports = class Request extends Writable {
  ...
  _performRequest() {
    ...
    this.setHeader("sec-ch-ua", '"Google Chrome";v="105", "Not)A;Brand";v="8", "Chromium";v="105"')
    this.setHeader("sec-ch-ua-mobile", "?0")
    this.setHeader("sec-ch-ua-platform", "Windows")
    this.setHeader("Accept-Encoding", "gzip, deflate, br")
    this.setHeader("Accept-Language", "en-US,en;q=0.9")
