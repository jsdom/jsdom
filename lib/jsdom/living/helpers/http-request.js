...
module.exports = class Request extends Writable {
  ...
  _performRequest() {
    ...
    let urlOptionsClone = {};
    {
        ...
        urlOptionsClone = {href,origin,protocol,username,password,host,hostname,port,pathname,search};
        urlOptionsClone.path = urlOptionsClone.pathname;
    }
    this._currentRequest = request(Object.assign(urlOptionsClone, this._requestOptions), response => {
