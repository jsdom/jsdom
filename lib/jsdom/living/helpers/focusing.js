...
exports.focusFixupRule = activeElement => {
  ...
  if (isConnected) {
    const target = fallbackTarget || document;
    exports.fireFocusEventWithTargetAdjustment("blur", activeElement, target);
    exports.fireFocusEventWithTargetAdjustment("focusout", activeElement, target, { bubbles: true });
  }

  document._lastFocusedElement = fallbackTarget || document;
