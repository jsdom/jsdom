...
exports.isFocusableAreaElement = elImpl => {
  ...
  while (current) {
    if (current.nodeType === NODE_TYPE.ELEMENT_NODE) {
      // TODO: jsdom does not yet have a comprehensive internal concept of "inertness".
      // Once #4350 (inert) is fully integrated, this might need refinement.
      if (current.hasAttributeNS(null, "hidden") || current.hasAttributeNS(null, "inert")) {
        return false;
      }
      // TODO: This only checks inline styles. A full check would require computed styles.
