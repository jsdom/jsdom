...
const { closest } = require("./traversal");
...
// instead caclulates the current form owner only when the property is accessed. To the
// best of my knowledge this provides the same results as the implementation described
// by the spec.
