...
const systemColors = new Map([
  ...
  ["buttonborder", "rgb(105, 105, 105)"],
  ["buttonface", "rgb(211, 211, 211)"],
  ["buttontext", "rgb(0, 0, 0)"],
  ["canvas", "rgb(255, 255, 255)"],
  ["canvastext", "rgb(0, 0, 0)"],
  ["field", "rgb(255, 255, 255)"],
  ["fieldtext", "rgb(0, 0, 0)"],
  ["graytext", "rgb(105, 105, 105)"],
  ["highlight", "rgb(51, 0, 255)"],
  ["highlighttext", "rgb(255, 255, 255)"],
  ["linktext", "rgb(0, 0, 255)"],
  ["mark", "rgb(255, 255, 0)"],
  ["marktext", "rgb(0, 0, 0)"],
  ["selecteditem", "rgb(51, 153, 255)"],
...
function getComputedValue(element, property) {
  ...
  if (computedValue === "as-specified") {
    ...
    if (specifiedValue === "inherit") {
      if (element.parentElement !== null) {
        return getComputedValue(element.parentElement, "color");
      }
      return initial;
    }
    if (systemColors.has(specifiedValue.toLowerCase())) {
      return systemColors.get(specifiedValue.toLowerCase());
    }
