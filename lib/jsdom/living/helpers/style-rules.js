...
function forEachMatchingSheetRuleOfElement(elementImpl, handleRule) {
  ...
  forEach.call(elementImpl._ownerDocument.adoptedStyleSheets, handleSheet);

  const rootNode = elementImpl.getRootNode();
  if (isShadowRoot(rootNode)) {
    forEach.call(rootNode.styleSheets._list, handleSheet);
    forEach.call(rootNode.adoptedStyleSheets, handleSheet);
  }
}
