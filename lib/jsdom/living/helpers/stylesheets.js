...
exports.createStylesheet = (sheetText, elementImpl, baseURLString, parserOptions) => {
  ...
  // TODO(cssom-upstream): This post-parse replacement should be removed once
  // @acemir/cssom supports passing jsdom's CSSStyleDeclaration class into parse().
  // TODO(cssom-upstream): Keep this close to parse() so all stylesheet entry points
  // consistently receive upgraded declarations.
  upgradeStyleDeclarations(sheet, elementImpl._globalObject);
