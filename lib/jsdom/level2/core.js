var core                     = require("../level1/core").dom.level1.core,
    ...
    ns = {
      validate : function(namespace, namespaceURI) {
        if (!namespace) {
          throw new core.DOMException(core.INVALID_CHARACTER_ERR, "namespace is undefined");
        }
        if(namespace.match(/[^0-9a-z\.:\-_]/i) !== null) {
          throw new core.DOMException(core.INVALID_CHARACTER_ERR, namespace);
        }
        if ((namespace === 'xmlns' && namespaceURI !== "http://www.w3.org/2000/xmlns/")        ||
            (namespace === "xml"   && namespaceURI !== "http://www.w3.org/XML/1998/namespace") ||
            namespace.indexOf('::') > -1                                                ||
