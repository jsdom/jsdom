...
/* TODO: Clean the document._id cache upon removal.

  core.Element.prototype.removeChild = function(oldChild){
  // remove the id if it exists
  if (oldChild.hasAttribute("id")) {
    this._ownerDocument._ids[oldChild.getAttribute("id").nodeValue];
  }
  return core.Node.prototype.removeChild(oldChild);
};*/
