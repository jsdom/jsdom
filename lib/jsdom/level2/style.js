...
// Temporary patch until https://github.com/chad3814/CSSStyleDeclaration/issues/28 has a solution
{
  const superPrivateSetProperty = core.CSSStyleDeclaration.prototype._setProperty;
  core.CSSStyleDeclaration.prototype._setProperty = function () {
    superPrivateSetProperty.apply(this, arguments);
  ...
  const superRemoveProperty = core.CSSStyleDeclaration.prototype.removeProperty;
  core.CSSStyleDeclaration.prototype.removeProperty = function () {
    superRemoveProperty.apply(this, arguments);
...
StyleSheetList.prototype.item = function item(sheet) {
  return this[i];
};
