...
core.ProgressEvent = function(eventType, eventInit) {
...
inheritFrom(core.Event, core.ProgressEvent, {
    initProgressEvent: function(type, bubbles, cancelable, lengthComputable, loaded, total) {
        this.initEvent(type, bubbles, cancelable);
