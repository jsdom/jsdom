...
core.Document.prototype.createEvent = function(eventType) {
    switch (eventType) {
        case "MutationEvents": return new core.MutationEvent();
        case "UIEvents": return new core.UIEvent();
        case "MouseEvents": return new core.MouseEvent();
        case "HTMLEvents": return new core.Event();
    }
