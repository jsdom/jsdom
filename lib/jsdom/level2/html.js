...
core.resourceLoader = {
  load: function(element, href, callback) {
    ...
    if ((ownerImplementation.hasFeature('FetchExternalResources', element.tagName.toLowerCase()))||(element._bgimage)) {
...
//  request.on('error', callback);
	...
	request.on('error', function(err) {doc._queue.filldatat(item,err,'')});
