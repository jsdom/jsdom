  ...
  proto: {
    ...
    set value(val) {
      ...
      if (this._allowSelection()) {
        // Ensure selection doesn't go past end of new value
    ...
    get selectionStart() {
      if(!this._allowSelection()) {
        throw new core.DOMException(core.INVALID_STATE_ERR);
      }
...
define('HTMLTextAreaElement', {
  ...
  proto: {
    ...
    set value(val) {
      ...
      this.selectionStart = this.selectionStart; // Ensure selection doesn't go past end of new value
    },
    get textLength() {
