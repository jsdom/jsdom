...
core.HTMLDocument = function(url, documentRoot) {
  core.Document.call(this);
  this._URL = url || '/';
  this._documentRoot = documentRoot || Path.dirname(this._URL);
};
...
core.HTMLDocument.prototype = {
  load: function(html) {
    ...
    core.resourceLoader.enqueue(this, function() {
      var loadEvent = this.createEvent('HTMLEvents');
    ...
    setAttribute: function(name, value) {
      ...
      if (name === "src") {
        ...
        core.resourceLoader.load(this, value, function(html, filename) {
          this._contentDocument = new core.HTMLDocument(value, this.ownerDocument._documentRoot);
          this._contentDocument.load(html);
        });
      }
    },
