...
define('HTMLElement', {
  ...
  init: function () {
    this._style = new core.CSSStyleDeclaration();
    this._settingCssText = false;

    // Hack for https://github.com/chad3814/CSSStyleDeclaration/issues/28
    // See also the comment in level2/style.js.
    var that = this;
    this._style.__onPropertyChanged = function () {
      if (!that._settingCssText) {
        that.setAttribute('style', that._style.cssText);
      }
    };
  },
  proto : {
