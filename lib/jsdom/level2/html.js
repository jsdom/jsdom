...
define('HTMLOptionElement', {
  tagName: 'OPTION',
  proto: {
    _selectedness: false, // todo: form reset should set this to the default
    _dirtyness: false, // todo: form reset should set this to false
    ...
    get selected() {
      if (!this._selectedness && this.parentNode) {
        ...
        if (select) {
          ...
          if (options.item(0) === this && !select.hasAttribute('multiple')) {
            var optArray = options._toArray();

            for (var i = 1, l = optArray.length; i<l; i++) {
              if (optArray[i]._selectedness) {
                return false;
              }
            }
            return true;
...
define('HTMLInputElement', {
  ...
  proto: {
    _value: null,
    _dirtyValue: false, // todo: form reset should set this to false
    _checkedness: false, // todo: form reset should set this to the default
    _dirtyCheckedness: false, // todo: form reset should set this to false
    _attrModified: function(name, value) {
...
define('HTMLTextAreaElement', {
  tagName: 'TEXTAREA',
  proto: {
    _apiValue: null, // todo: form reset should set this to null
    _dirtyValue: false, // todo: form reset should set this to false
