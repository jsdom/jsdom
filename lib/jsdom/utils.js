 ...
 *
 * - `object` {Object} the object to define the constant on
 * - `property` {String} the name of the property
 * - `value` {*} the value
 */
exports.addConstant = function addConstant(object, property, value) {
...
/**
 * Define a list of constants on an object
 * - `object` {Object} the object to define the constants on
 * - `propertyMap` {Object}  key/value map of properties to define
 */
exports.addConstants = function addConstant(object, propertyMap) {
  for (var property in propertyMap) {
    var value = propertyMap[property];
    exports.addConstant(object, property, value);
  }
};
