...
if (canvasInstalled) {
  ...
  // provide mock canvas
  // based on https://www.npmjs.com/package/canvas-mock
  const toBlob = function (callback, type, qualityArgument) {};
  const toDataURL = function(...args) {};
  const toBuffer = function() {};
  const getContext = function(contextId) {
  return {
    fillRect: function() {},
    clearRect: function(){},
  ...
  exports.Canvas = { Image, createCanvas, getContext, toBlob, toDataURL, toBuffer }
}
