...
exports.testEvaluateWildcardChild = function(test) {
  ...
  test.deepEqual(xpath.stringifyContext({nodes:[div0,div1], pos: [[1],[2]], lasts: [[2],[2]]}), xpath.stringifyContext(x));
  test.done();
};
...
exports.testEvaluateRoot = function(test) {
  ...
  test.deepEqual(xpath.stringifyContext({nodes:[doc]}), xpath.stringifyContext(x));
  test.done();
};
exports.testEvaluateSelf = function(test) {
  ...
  test.deepEqual(
    xpath.stringifyContext(
      {nodes: [div0, div1],
       pos: [[1], [1]],
       lasts: [[1],[1]]}),
    xpath.stringifyContext(newCtx));
  test.done();
};
...
exports.testFollowingSibling = function(test) {
  ...
  test.deepEqual(
    xpath.stringifyContext({nodes:[four,five,six]}),
    xpath.stringifyContext(newCtx));
  test.done();
};
exports.testPrecedingSibling = function(test) {
  ...
  test.deepEqual(
    xpath.stringifyContext({nodes:[one,two]}),
    xpath.stringifyContext(newCtx));
  test.done();
};
...
exports.testEvaluatePositionAndLast = function(test) {
  ...
  test.deepEqual(
    xpath.stringifyContext({nodes:[one,two,three,six]}),
    xpath.stringifyContext(newCtx));
  test.done();
};
exports.testAttributePredicate = function(test) {
  ...
  test.deepEqual(
    xpath.stringifyContext({nodes:[a]}),
    xpath.stringifyContext(newCtx));
  test.done();
};
...
exports.testAttributesHaveNoChildren = function(test) {
  ...
  var a = doc.getElementsByTagName('a')[0],
      ...
      i = doc.getElementsByTagName('i')[0];
  test.deepEqual(
    xpath.stringifyContext({nodes: [b], pos: [[1]], lasts: [[1]]}),
    xpath.stringifyContext(xpath.evaluateImpl('parent::node()', doc, attr)));
  test.deepEqual(
    xpath.stringifyContext({nodes: [attr], pos: [[1]], lasts: [[1]]}),
    xpath.stringifyContext(xpath.evaluateImpl('self::node()', doc, attr)));
  test.deepEqual(
    xpath.stringifyContext({nodes: [], pos: [], lasts: []}),
    xpath.stringifyContext(xpath.evaluateImpl('child::node()', doc, attr)));
  test.deepEqual(
    xpath.stringifyContext({nodes: []}),
    xpath.stringifyContext(xpath.evaluateImpl('descendant::node()', doc, attr)));
  test.deepEqual(
    xpath.stringifyContext({nodes: [attr]}),
    xpath.stringifyContext(xpath.evaluateImpl('descendant-or-self::node()', doc, attr)));
  // Note: following DOES include the children of the element that the
  // attribute belongs to.
  test.deepEqual(
    xpath.stringifyContext({nodes: [btext, i]}),
    xpath.stringifyContext(xpath.evaluateImpl('following::node()', doc, attr)));
  test.deepEqual(
    xpath.stringifyContext({nodes: []}),
    xpath.stringifyContext(xpath.evaluateImpl('following-sibling::node()', doc, attr)));
  test.deepEqual(
    xpath.stringifyContext({nodes: [a], pos: [[1]], lasts: [[1]]}),
    xpath.stringifyContext(xpath.evaluateImpl('preceding::node()', doc, attr)));
  test.deepEqual(
    xpath.stringifyContext({nodes: []}),
    xpath.stringifyContext(xpath.evaluateImpl('preceding-sibling::node()', doc, attr)));
  test.done();
};
...
exports.testAttributeNodePredicate = function(test) {
  ...
  test.deepEqual(xpath.stringifyContext({nodes:[]}), xpath.stringifyContext(result));
  console.log(".//@id[1]/parent::*")
  result = xpath.evaluateImpl(".//@id[1]/parent::*", doc, root);
  test.deepEqual(
    xpath.stringifyContext({nodes:[child21, child22, child23],
                      pos: [ [ 1 ], [ 1 ], [ 1 ] ],
                      lasts: [ [ 1 ], [ 1 ], [ 1 ] ]}),
    xpath.stringifyContext(result));
  console.log(".//@id[2]/parent::*")
  result = xpath.evaluateImpl(".//@id[2]/parent::*", doc, root);
  test.deepEqual(xpath.stringifyContext({nodes:[],pos:[],lasts:[]}), xpath.stringifyContext(result));
  console.log(".//@id[string()='21']/parent::*")
  result = xpath.evaluateImpl(".//@id[string()='21']/parent::*", doc, root);
  test.deepEqual(
    xpath.stringifyContext({nodes:[child21], pos:[[1]],lasts:[[1]]}),
    xpath.stringifyContext(result));
  console.log(".//@id[string()='22']/parent::*")
  result = xpath.evaluateImpl(".//@id[string()='22']/parent::*", doc, root);
  test.deepEqual(
    xpath.stringifyContext({nodes:[child22], pos:[[1]],lasts:[[1]]}),
    xpath.stringifyContext(result));
  test.done();
};
