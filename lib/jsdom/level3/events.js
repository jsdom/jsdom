var core = require('./core').dom.level3.core,
    events = require("../level2/events").dom.level2.events,
    utils = require('../utils'),
...
core.Document.prototype.createEvent = function(eventType) {
    switch (eventType) {
        ...
        case "KeyboardEvent": return new events.KeyboardEvent(eventType);
        case "InputEvents": return new events.InputEvent(eventType)
        case "FocusEvent": return new events.FocusEvent(eventType)
    }
...
events.TextEvent = function (eventType) {
  events.UIEvent.call(this, eventType)
  this.eventType = eventType
  this.data = null
}
inheritFrom(events.UIEvent, events.TextEvent, {
    initTextEvent:    function(type,
                               bubbles,
                               cancelable,
                               view,
                               data) {
      this.initUIEvent(type, bubbles, cancelable, view, null)
    }
})

events.FocusEvent = function (eventType) {
  events.UIEvent.call(this, eventType)
  this.eventType = eventType
  this.foo = 'bar'
}
inheritFrom(events.UIEvent, events.FocusEvent, {
    initFocusEvent:    function(type,
                                bubbles,
                                cancelable,
                                view,
                                data) {
...
inheritFrom(events.UIEvent, events.KeyboardEvent, {
    initKeyboardEvent:    function(type,
                               bubbles,
                               cancelable,
                               view,
                               data) {
...
events.InputEvent = function (eventType) {
  events.UIEvent.call(this, eventType)
}
inheritFrom(events.UIEvent, events.InputEvent, {
    initInputEvent: function (type,
                              bubbles,
                              cancelable,
                              view) {
      this.initUIEvent(type, bubbles, cancelable, view, null)
