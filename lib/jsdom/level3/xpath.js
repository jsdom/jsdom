...
// The main function that this file exports: xpath.extend(window)
xpath.extend = function extend(core) {
...
xpath.Stream = Stream;
xpath.parse = parse;
xpath.evaluateImpl = evaluateImpl;
xpath.sortUniqDocumentOrder = sortUniqDocumentOrder;
xpath.stringifyObject = stringifyObject;
...
function sortUniqDocumentOrder(nodes) {
  var a = [];
