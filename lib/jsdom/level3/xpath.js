...
exp.stringifyContext = function stringifyContext(ctx) {
  ...
  var seen = 'seen' + Math.floor(Math.random()*1000000000);
  function helper(ctx) {
    ...
    switch (ast[0]) {
      ...
      case 'Predicate':
        ...
        for (var i = 0; i < contexts.length; ++i) {
          ...
          //console.log('number predicate ' + singleNodeSet.pos[0][0] + ' for node ' + stringifyContext(contexts[i]) + ': success=' + success);
          if (success) {
