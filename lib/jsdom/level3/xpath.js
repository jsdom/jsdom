...
module.exports = core => {
  ...
  var XPathResult = xpath.XPathResult = function XPathResult(doc, value, resultType) {
    ...
    if (this.resultType === XPathResult.UNORDERED_NODE_ITERATOR_TYPE ||
      ...
      this._documentImpl = idlUtils.implForWrapper(doc);
      this._documentVersion = this._documentImpl._version;
    }
  }
  ...
  var proto = {
    ...
    get invalidIteratorState() {
      if (XPathResult.UNORDERED_NODE_ITERATOR_TYPE !== this.resultType &&
        ...
        return false;
      return this._documentImpl._version !== this._documentVersion;
    },
    get snapshotLength() {
    ...
    iterateNext: function iterateNext() {
      if (XPathResult.UNORDERED_NODE_ITERATOR_TYPE !== this.resultType &&
          XPathResult.ORDERED_NODE_ITERATOR_TYPE !== this.resultType)
        throw new TypeError('You should have asked for a ORDERED_NODE_ITERATOR_TYPE.');
