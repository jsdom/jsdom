...
var DOCUMENT_POSITION_PRECEDING    = core.Node.DOCUMENT_POSITION_PRECEEDING =
...
core.Node.prototype.contains = function (other) {
  return other === this || !!(this.compareDocumentPosition(other) & DOCUMENT_POSITION_CONTAINED_BY);
}
