...
EventTarget.prototype.dispatchEvent = function (event) {
  ...
  if (event._type === null || event._type === "") {
    ...
    // TODO: use real error here. Hard because of circular dependencies with core.
//    throw new core.DOMException(core.DOMException.INVALID_STATE_ERR, "Tried to dispatch an uninitialized event");
  }
