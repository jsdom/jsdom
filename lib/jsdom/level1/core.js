...
core.NodeList.prototype = {
  // TODO:
  // Swizec - this is where I traced the root of removeChild issue
  // the fix is to make list[i] access the same as list.item(i)
  // if anyone better than me can do that, awesome, I tried several ways
  update: function(first_time) {
    var first_time = first_time || false;
...
core.Node.prototype = {
  ...
  replaceChild : function(/* Node */ newChild, /* Node */ oldChild){
	...
	console.log("wrong");
      ...
      //console.log(oldChild.parentNode.id);
      //console.log("");
    for (var i=0;i<this._childArray.length;i++)
    {
...
core.Element.prototype = {
  ...
  get attributes() { 
      // Swizec - some scripts expect access to attributes by index
