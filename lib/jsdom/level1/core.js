...
var createThisMixins = require("../utils").createThisMixins;
...
core.Node = function Node(ownerDocument) {
  ...
  var wnd = ownerDocument && ownerDocument.defaultView;
  if (wnd) {
    this.attachEventListener = wnd.attachEventListener;
    this.removeEventListener = wnd.removeEventListener;
    this.dispatchEvent = wnd.dispatchEvent;
  }
