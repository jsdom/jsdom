...
core.Node.prototype = {
  ...
  get nodeName() {
    ...
    if (this.nodeType === ELEMENT_NODE &&
        ...
        this._ownerDocument.doctype.name.indexOf("html") !== -1)
    {
  ...
  insertBefore :  function(/* Node */ newChild, /* Node*/ refChild){
    ...
    if (newChild.ownerDocument !== this._ownerDocument) {
  ...
  appendChild : function(/* Node */ newChild){
    ...
    if (newChild.ownerDocument &&
        this._ownerDocument     &&
        newChild.ownerDocument !== this._ownerDocument) {
...
core.Element.prototype = {
  ...
  setAttributeNode: function(/* Attr */ newAttr) {
    ...
    if (newAttr.ownerDocument !== this._ownerDocument) {
      throw new core.DOMException(WRONG_DOCUMENT_ERR);
    }
