...
core.Node.prototype = {
  ...
  /* returns Node */
  cloneNode : function(/* bool */ deep, fn) { // TODO remove fn argument

    var object = null;
    switch (this.nodeType) {

      case this.ELEMENT_NODE:
        object = this._ownerDocument._createElementNoTagNameValidation(this.nodeName);
        object._namespaceURI = this._namespaceURI;
        attributes.copyAttributeList(this, object);
      ...
      case this.TEXT_NODE:
        object = this._ownerDocument.createTextNode(this._data);
      break;
      case this.ATTRIBUTE_NODE:
        // TODO Attr: remove this and other code in this function; attributes aren't nodes and aren't clonable
        object = this._ownerDocument.createAttribute(this.name);
      break;
      break;
      case this.PROCESSING_INSTRUCTION_NODE:
        object = this._ownerDocument.createProcessingInstruction(this._target,
                                                                this._data);
      break;
      ...
      case this.DOCUMENT_NODE:
        object = new this.constructor({ parsingMode: this._parsingMode });
