...
const parseContentType = require("./jsdom/utils").parseContentType;
...
exports.env = exports.jsdom.env = function () {
  ...
  function handleUrl() {
    ...
    return resourceLoader.download(config.url, options, config.cookieJar, null, true,
    (err, responseText, res) => {
      ...
      if (contentType) {
        config.characterSet = contentType.get("charset");
      }
