...
const xtend = require("xtend/mutable"); // TODO replace with Object.assign when io.js support is dropped.
...
exports.env = exports.jsdom.env = function () {
  ...
  if (config.file && canReadFilesFromFS) {
    ...
    if (url.protocol && url.hostname) {
      ...
      fs.readFile(config.somethingToAutodetect, "utf-8", (err, text) => {
        if (err) {
