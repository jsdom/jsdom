...
require('./jsdom/level2/style'); // side effects
...
exports.jsdom = function (html, options) {
  ...
  var browser = browserAugmentation(dom.living.html, options);
  ...
  require('./jsdom/selectors/index').applyQuerySelectorPrototype(dom.living.html);
