...
(function () {
    ...
    exports['Document contains and precedes a newly attached comment and vice versa'] = function (t) {
      ...
      t.ok(doc.compareDocumentPosition(comment) & core.Node.DOCUMENT_POSITION_CONTAINED_BY, 'Document contains');
      t.ok(doc.compareDocumentPosition(comment) & core.Node.DOCUMENT_POSITION_FOLLOWING, 'Document precedes');
      t.ok(comment.compareDocumentPosition(doc) & core.Node.DOCUMENT_POSITION_CONTAINS, 'Comment contained');
      t.ok(comment.compareDocumentPosition(doc) & core.Node.DOCUMENT_POSITION_PRECEDING, 'Comment follows');
      t.done();     
    };
    ...
    exports['Document fragment contains and precedes a newly attached nide and vice versa'] = function (t) {
      ...
      t.ok(fragment.compareDocumentPosition(span) & core.Node.DOCUMENT_POSITION_CONTAINED_BY, 'Fragment contains');
      t.ok(fragment.compareDocumentPosition(span) & core.Node.DOCUMENT_POSITION_FOLLOWING, 'Fragment precedes');
      t.ok(span.compareDocumentPosition(fragment) & core.Node.DOCUMENT_POSITION_CONTAINS, 'Span contained');
      t.ok(span.compareDocumentPosition(fragment) & core.Node.DOCUMENT_POSITION_PRECEDING, 'Span follows');
      t.done();     
    };
    ...
    exports['Newly appended ProcessingInstruction node follows older appended ProcessingInstruction Node'] = function (t) {
      ...
      t.ok(pi1.compareDocumentPosition(pi2) & core.Node.DOCUMENT_POSITION_FOLLOWING, 'Second PI Follows');
      t.ok(pi2.compareDocumentPosition(pi1) & core.Node.DOCUMENT_POSITION_PRECEDING, 'First PI Precedes');
      t.done();
    };
    ...
    exports['Newly appended Text node follows older appended Text Node'] = function (t) {
      ...
      t.ok(t1.compareDocumentPosition(t2) & core.Node.DOCUMENT_POSITION_FOLLOWING, 'Second Text Node Follows');
      t.ok(t2.compareDocumentPosition(t1) & core.Node.DOCUMENT_POSITION_PRECEDING, 'First Text Node Precedes');
      t.done();
    };
    ...
    exports['Existing element precedes one later in the markup and vice versa'] = function (t) {
      ...
      t.ok(el1.compareDocumentPosition(el2) & core.Node.DOCUMENT_POSITION_FOLLOWING, 'Second Element Follows');
      t.ok(el2.compareDocumentPosition(el1) & core.Node.DOCUMENT_POSITION_PRECEDING, 'First Element Precedes');
      t.done();
    };
    ...
    exports['Element contains and precedes a decendant node and vice versa'] = function (t) {
      ...
      t.ok(span.compareDocumentPosition(strong) & core.Node.DOCUMENT_POSITION_CONTAINED_BY, 'Span contains');
      t.ok(span.compareDocumentPosition(strong) & core.Node.DOCUMENT_POSITION_FOLLOWING, 'Span precedes');
      t.ok(strong.compareDocumentPosition(span) & core.Node.DOCUMENT_POSITION_CONTAINS, 'Strong contained');
      t.ok(strong.compareDocumentPosition(span) & core.Node.DOCUMENT_POSITION_PRECEDING, 'Strong follows');
      t.done();
    };
    ...
    exports['A Child node precedes a child of a node later in the markup'] = function (t) {
      ...
      t.ok(strong.compareDocumentPosition(em) & core.Node.DOCUMENT_POSITION_FOLLOWING, 'Second Element Follows');
      t.ok(em.compareDocumentPosition(strong) & core.Node.DOCUMENT_POSITION_PRECEDING, 'First Element Precedes');
      t.done();
    };
    ...
    exports['A newly attached child node precedes a child node later in the markup'] = function (t) {
      ...
      t.ok(newEl.compareDocumentPosition(em) & core.Node.DOCUMENT_POSITION_FOLLOWING, 'Second Element Follows');
      t.ok(em.compareDocumentPosition(newEl) & core.Node.DOCUMENT_POSITION_PRECEDING, 'New Element Precedes');
      t.done();
    };
    ...
    exports['A newly attached child node follows a child node earlier in the markup'] = function (t) {
      ...
      t.ok(newEl.compareDocumentPosition(strong) & core.Node.DOCUMENT_POSITION_PRECEDING, 'Second Element Precedes');
      t.ok(strong.compareDocumentPosition(newEl) & core.Node.DOCUMENT_POSITION_FOLLOWING, 'New Element Follows');
      t.done();
    };
