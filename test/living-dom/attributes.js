...
exports["setNamedItem and removeNamedItem on `attributes` should add and remove fields from `attributes`"] =
function (t) {

  var doc = jsdom.jsdom();
  var map = doc.body.attributes;
...
exports["setNamedItem and removeNamedItem on `attributes` should not interfere with existing method names"] =
function (t) {
  var doc = jsdom.jsdom();
  var map = doc.body.attributes;
...
exports["setting an attribute should not overwrite the methods of an `NamedNodeMap` object"] = function (t) {
  var doc = load("minimal");
  var body = doc.getElementsByTagName("body")[0];
  t.ok(body, "body is not null");
...
exports["setting an attribute should not overwrite the methods defined by parents of an `NamedNodeMap` " +
        "object"] = function (t) {
  var doc = load("minimal");
  var body = doc.getElementsByTagName("body")[0];
  t.ok(body, "body is not null");
...
exports["setting an attribute should not overwrite the fields of an `NamedNodeMap` object"] = function (t) {
  var doc = load("minimal");
  var body = doc.getElementsByTagName("body")[0];
  t.ok(body, "body is not null");
