    ...
    jsdom.env({
      ...
      scripts: [
        ...
        function qunitDeepEqual(actual, expected, assertionMessage) {
          ...
          if (areEqual) {
            assert.ok(true, assertionMessage);
          } else {
            ...
            if (!idsEqual) {
              assert.deepEqual(actualIds, expectedIds, assertionMessage);
            } else {
              assert.ok(false, assertionMessage);
            }
          }
        }
...
describe("sizzle", { skipIfBrowser: true }, () => {
  ...
  specify('broken', test(function (window) {
    with (window) {
  ...
  specify('name', test(function (window) {
    with (window) {
  ...
  specify('attributes', test(function (window) {
    with (window) {
  ...
  specify('pseudo - child', test(function (window) {
    with (window) {
  ...
  specify('pseudo - misc', test(function (window) {
    with (window) {
  ...
  specify('pseudo - :not', test(function (window) {
    with (window) {
  ...
  specify('pseudo - position', test(function (window) {
    with (window) {
  ...
  specify('pseudo - form', test(function (window) {
    with (window) {
