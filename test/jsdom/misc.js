...
describe("jsdom/miscellaneous", () => {
  ...
  it("jquerify_file", {skipIfBrowser: true, async: true}, testCase => {
  ...
  it("jquerify_url", {async: true}, testCase => {
  ...
  it("jquerify_invalid", {async: true}, testCase => {
  ...
  it("jquerify_attribute_selector_gh_400", {skipIfBrowser: true, async: true}, testCase => {
    const window = jsdom.jsdom().defaultView;
  ...
  it("env_with_https", {async: true}, testCase => {
  ...
  it("env_with_compression", {skipIfBrowser: true, async: true}, testCase => {
  ...
  it("env_with_features_and_external_resources", {skipIfBrowser: true, async: true}, testCase => {
    jsdom.env(
  ...
  it("appendChild_to_document_with_existing_documentElement", () => {
    const t = function(){
      try {
        const doc = jsdom.jsdom();
  ...
  it("ensure_scripts_can_be_disabled_via_options_features", {skipIfBrowser: true, async: true}, testCase => {
  ...
  it("ensure_scripts_can_be_executed_via_options_features", {skipIfBrowser: true, async: true}, testCase => {
    const html = "<html><head><script src='./files/hello.js'></script></head>" +
               "<body><span id='test'>hello from html</span></body></html>";
  ...
  it("ensure_resolution_is_not_thrown_off_by_hrefless_base_tag", {skipIfBrowser: true, async: true}, testCase => {
  ...
  it("ensure_resources_can_be_skipped_via_options_features", {skipIfBrowser: true, async: true}, testCase => {
  ...
  it("understand_file_protocol", {skipIfBrowser: true, async: true}, testCase => {
    const html = '\
      <html>\
        <head>\
  ...
  it("window_is_augmented_with_dom_features", () => {
  ...
  it("auto_tostring", {skipIfBrowser: true}, () => {
  ...
  it("childNodes_updates_on_insertChild", () => {
    const window = jsdom.jsdom("").defaultView;
  ...
  it("children_should_be_available_right_after_document_creation", () => {
  ...
  it("children_should_be_available_right_after_document_creation_scripts", () => {
  ...
  it("parsing_and_serializing_entities", () => {
  ...
  it("parsing_and_serializing_unknown_entities", () => {
  ...
  it("entities_in_script_should_be_left_alone", () => {
  ...
  it("document_title_and_entities", () => {
  ...
  it("setting_and_getting_textContent", () => {
  ...
  it("allow_ender_to_run", {skipIfBrowser: true, async: true}, testCase => {
  ...
  it("test_body_event_handler_inline", {async: true}, testCase => {
    const html = "\
      <html>\
        <head>\
          <script>\
  ...
  it("test_body_event_handler_script", {async: true}, testCase => {
  ...
  it("test_element_inline_event_handler", () => {
    const doc = jsdom.jsdom(
      "<html>" +
        "<head></head>" +
        "<body>" +
  ...
  it("issue_335_inline_event_handlers", () => {
  ...
  it("issue_355_on_events_should_not_execute_js_when_disabled", {async: true}, testCase => {
  ...
  it("issue_361_textarea_value_property", () => {
  ...
  it("on_events_should_be_called_in_bubbling_phase", () => {
    const doc = jsdom.jsdom(
      "<html>" +
        "<head></head>" +
        "<body>" +
  ...
  it("css_classes_should_be_attached_to_dom", () => {
  ...
  it("issue_509_out_of_memory", {skipIfBrowser: true}, () => {
    const fs = require("fs");
  ...
  it("issue_530_async_load_events", {async: true}, testCase => {
    const doc = jsdom.jsdom('<html><head></head><body></body></html>');
    const window = doc.defaultView;
  ...
  it("jquery_val_on_selects", {skipIfBrowser: true, async: true}, testCase => {
    const window = jsdom.jsdom().defaultView;
  ...
  it("jquery_attr_mixed_case", {skipIfBrowser: true, async: true}, testCase => {
    const window = jsdom.jsdom().defaultView;
  ...
  it("Calling show() method in jQuery 1.11.0 (GH-709)", {skipIfBrowser: true, async: true}, testCase => {
  ...
  it("Calling show() method in jQuery 1.11.0, second case (GH-709)", {skipIfBrowser: true, async: true}, testCase => {
    const window = jsdom.jsdom("<!DOCTYPE html><html><head></head><body></body></html>").defaultView;
  ...
  it("redirected_url_equal_to_location_href", {skipIfBrowser: true, async: true}, testCase => {
  ...
  it("issue_935_document_tostring_returns_null", () => {
    const document = jsdom.jsdom();
    test.equal(document.toString(), "[object HTMLDocument]");
  });

  it("script_with_cookie", {skipIfBrowser: true, async: true}, testCase => {
  ...
  it("xhr_with_cookie", {skipIfBrowser: true, async: true}, testCase => {
  ...
  it("no global leak when using window.location.reload", () => {
  ...
  it("custom userAgent inherits to iframes", () => {
