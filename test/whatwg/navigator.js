...
exports["navigator properties should be read-only from the site"] = function (t) {
  ...
  jsdom.env({
    html: '<!doctype html><html><head><script type="text/javascript">navigator.userAgent = "test";navigator.platform = "test";navigator.appName = "test";navigator.appVersion = "test";</script></head><body></body></html>',
