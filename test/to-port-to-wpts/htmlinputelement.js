...
describe("htmlinputelement", () => {
  ...
  specify(
    ...
    () => {
      const date = new Date(2019, 11, 5, 8, 15);
      ...
      const expectedValueForMonth = new Date(2019, 11, 1);
      ...
      const expectedValueForWeek = new Date(2019, 11, 2);
      ...
      const expectedValueForTime = new Date(1970, 0, 1, 8, 15);
