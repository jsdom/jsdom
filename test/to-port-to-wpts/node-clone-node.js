...
describe("node-clone-node", () => {
  ...
  test("Cloning a document fragment node, shallowly", () => {
  ...
  test("Cloning a document fragment node, deeply", () => {
    const doc = (new JSDOM()).window.document;
  ...
  test("Deep heterogenous clone of a document", () => {
