...
function testHTMLDocument(document) {
  ...
  assert.strictEqual(p.getAttribute("xmlns:xlink"), "http://www.w3.org/1999/xlink",
  ...
  assert.strictEqual(xmlnsAttr.namespaceURI, null,
  ...
  assert.strictEqual(img.namespaceURI, "http://www.w3.org/1999/xhtml",
    "html elements should automatically be assigned the XHTML namespace");

  assert.strictEqual(img.getAttribute("xlink:href"), "#test",
    "attributes should be retrievable by their full name");
  ...
  assert.strictEqual(xlinkAttr.namespaceURI, null,
...
describe("jsdom/namespaces", () => {
  ...
  function testDocumentWithSVG(document) {
    ...
    assert.strictEqual(svg.getAttribute("xmlns:xlink"), "http://www.w3.org/1999/xlink",
      "attributes should be retrievable by their full name");
    ...
    assert.strictEqual(xmlnsAttr.namespaceURI, "http://www.w3.org/2000/xmlns/",
    ...
    assert.strictEqual(use.getAttribute("xlink:href"), "#test",
      "attributes should be retrievable by their full name");
    ...
    assert.strictEqual(xlinkAttr.namespaceURI, "http://www.w3.org/1999/xlink",
